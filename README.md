...
# Assessmet Policy
● Allowed Resources: Only conultant oficial language manuals, specs, or standard library references for syntax or API help. Using any other resources (e.g., ChatGPT, plugins,
